...
export default function Footer() {
  ...
  const linkColumns = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: t("footer.c.privacy"), href: "#", onClick: () => setModal("privacy") },
        { label: t("footer.c.terms"), href: "#", onClick: () => setModal("terms") },
      ],
    },
  ];
  ...
  return (
    <>
      ...
      <LegalModal isOpen={modal === "privacy"} onClose={() => setModal(null)} type="privacy" />
      <LegalModal isOpen={modal === "terms"} onClose={() => setModal(null)} type="terms" />
    </>
  );
}