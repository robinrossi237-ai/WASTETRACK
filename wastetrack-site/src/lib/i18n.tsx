...
"footer.tagline":
    ...
    "footer.c.privacy": "Politique de confidentialité",
    "footer.c.terms": "Conditions d'utilisation",
    ...
    "privacy.intro": "WasteTrack (\"nous\", \"notre\", \"nos\") s'engage à protéger vos données personnelles. Cette politique explique quelles données nous collectons, comment nous les utilisons et vos droits.",
    "privacy.dataCollection.title": "1. Données collectées",
    "privacy.dataCollection.content": "Nous collectons : (a) données de compte (email, nom, rôle), (b) données de localisation (pour le suivi des ramassages), (c) données d'usage (interactions dans l'app), (d) données de paiement (via prestataires certifiés).",
    "privacy.usage.title": "2. Utilisation des données",
    "privacy.usage.content": "Vos données servent à : fournir le service (matching résident/collecteur, suivi temps réel), améliorer l'app, envoyer des notifications (ramassage, points), respecter nos obligations légales.",
    "privacy.sharing.title": "3. Partage",
    "privacy.sharing.content": "Nous ne vendons pas vos données. Partage limité à : prestataires techniques (hébergement, notifications push), autorités sur réquisition légale, partenaires de paiement (Stripe, Mobile Money).",
    "privacy.rights.title": "4. Vos droits",
    "privacy.rights.content": "Accès, rectification, effacement, portabilité, limitation, opposition. Exercez-les via l'app (réglages) ou email : robinrossi237@gmail.com.",
    "privacy.security.title": "5. Sécurité",
    "privacy.security.content": "Chiffrement TLS 1.3 en transit, AES-256 au repos. Accès restreint au personnel autorisé. Audits réguliers.",
    "privacy.retention.title": "6. Conservation",
    "privacy.retention.content": "Données de compte : tant que le compte existe + 3 ans après suppression. Données de localisation : 30 jours (sauf litige). Logs techniques : 12 mois.",
    "privacy.contact": "Questions : robinrossi237@gmail.com ou +237 6 53 46 81 23.",

    "terms.title": "Conditions d'utilisation",
    "terms.lastUpdated": "Dernière mise à jour : {date}",
    "terms.acceptance": "En utilisant WasteTrack, vous acceptez ces conditions. Si vous n'êtes pas d'accord, n'utilisez pas le service.",
    "terms.service.title": "1. Description du service",
    "terms.service.content": "WasteTrack connecte résidents et collecteurs pour le ramassage de déchets à la demande. L'app facilite la mise en relation, le suivi temps réel, le paiement et la récompense (points).",
    "terms.account.title": "2. Compte utilisateur",
    "terms.account.content": "Vous devez fournir des informations exactes. Vous êtes responsable de la confidentialité de vos identifiants. Un utilisateur = un compte. Rôle (résident/collecteur) choisi à l'inscription, modifiable sur demande.",
    "terms.collector.title": "3. Collecteurs",
    "terms.collector.content": "Les collecteurs sont des travailleurs indépendants. WasteTrack n'est pas employeur. Ils doivent respecter la réglementation locale (transport, déchets). WasteTrack prélève une commission sur chaque transaction.",
    "terms.payment.title": "4. Paiements & Points",
    "terms.payment.content": "Paiements via Mobile Money / carte (prestataires certifiés). Points non monétaires, non remboursables, utilisables selon votre plan. WasteTrack peut ajuster les taux de points avec préavis.",
    "terms.liability.title": "5. Limitation de responsabilité",
    "terms.liability.content": "Service fourni \"tel quel\". WasteTrack n'est pas responsable des retards, dommages indirects, ou actes des collecteurs indépendants. Responsabilité plafonnée aux frais payés sur 12 mois.",
    "terms.termination.title": "6. Résiliation",
    "terms.termination.content": "Vous pouvez supprimer votre compte à tout moment (réglages). WasteTrack peut suspendre en cas d'abus (fraude, harcèlement, fausses déclarations).",
    "terms.changes.title": "7. Modifications",
    "terms.changes.content": "Nous pouvons modifier ces conditions (notification dans l'app + email 15 jours avant). L'usage continu vaut acceptation.",
    "terms.law.title": "8. Droit applicable",
    "terms.law.content": "Droit camerounais. Litiges : tribunal compétent de Douala.",
    "terms.contact": "Contact : robinrossi237@gmail.com / +237 6 53 46 81 23.",

    "download.screenshots.alt": "Capture d'écran de l'application WasteTrack",
};
...
"footer.tagline":
    ...
    "footer.c.privacy": "Privacy Policy",
    "footer.c.terms": "Terms of Service",
    ...
    "privacy.intro": "WasteTrack (\"we\", \"our\", \"us\") is committed to protecting your personal data. This policy explains what data we collect, how we use it, and your rights.",
    "privacy.dataCollection.title": "1. Data collected",
    "privacy.dataCollection.content": "We collect: (a) account data (email, name, role), (b) location data (for pickup tracking), (c) usage data (in-app interactions), (d) payment data (via certified providers).",
    "privacy.usage.title": "2. Use of data",
    "privacy.usage.content": "Your data is used to: provide the service (resident/collector matching, real-time tracking), improve the app, send notifications (pickup, points), comply with legal obligations.",
    "privacy.sharing.title": "3. Sharing",
    "privacy.sharing.content": "We do not sell your data. Limited sharing with: technical providers (hosting, push notifications), authorities on legal request, payment partners (Stripe, Mobile Money).",
    "privacy.rights.title": "4. Your rights",
    "privacy.rights.content": "Access, rectification, erasure, portability, restriction, objection. Exercise them via the app (settings) or email: robinrossi237@gmail.com.",
    "privacy.security.title": "5. Security",
    "privacy.security.content": "TLS 1.3 encryption in transit, AES-256 at rest. Access restricted to authorized personnel. Regular audits.",
    "privacy.retention.title": "6. Retention",
    "privacy.retention.content": "Account data: while account exists + 3 years after deletion. Location data: 30 days (unless dispute). Technical logs: 12 months.",
    "privacy.contact": "Questions: robinrossi237@gmail.com or +237 6 53 46 81 23.",

    "terms.title": "Terms of Service",
    "terms.lastUpdated": "Last updated: {date}",
    "terms.acceptance": "By using WasteTrack, you accept these terms. If you disagree, do not use the service.",
    "terms.service.title": "1. Service description",
    "terms.service.content": "WasteTrack connects residents and collectors for on-demand waste pickup. The app facilitates matching, real-time tracking, payment and rewards (points).",
    "terms.account.title": "2. User account",
    "terms.account.content": "You must provide accurate information. You are responsible for credential confidentiality. One user = one account. Role (resident/collector) chosen at signup, changeable on request.",
    "terms.collector.title": "3. Collectors",
    "terms.collector.content": "Collectors are independent workers. WasteTrack is not an employer. They must comply with local regulations (transport, waste). WasteTrack takes a commission on each transaction.",
    "terms.payment.title": "4. Payments & Points",
    "terms.payment.content": "Payments via Mobile Money / card (certified providers). Points are non-monetary, non-refundable, usable per your plan. WasteTrack may adjust point rates with notice.",
    "terms.liability.title": "5. Limitation of liability",
    "terms.liability.content": "Service provided \"as is\". WasteTrack is not liable for delays, indirect damages, or acts of independent collectors. Liability capped at fees paid in 12 months.",
    "terms.termination.title": "6. Termination",
    "terms.termination.content": "You may delete your account anytime (settings). WasteTrack may suspend for abuse (fraud, harassment, false statements).",
    "terms.changes.title": "7. Changes",
    "terms.changes.content": "We may modify these terms (in-app + email notice 15 days prior). Continued use constitutes acceptance.",
    "terms.law.title": "8. Governing law",
    "terms.law.content": "Cameroonian law. Disputes: Douala competent court.",
    "terms.contact": "Contact: robinrossi237@gmail.com / +237 6 53 46 81 23.",

    "download.screenshots.alt": "WasteTrack app screenshot",
};
